...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_SELECT_FIRST_BY_EXAMPLE_STATEMENT_ID,
    ...
    protected void calculateXmlAttributes() {
        ...
        setSelectFirstByExampleStatementId("selectFirstByExample"); //$NON-NLS-1$
    ...
    public void setSelectFirstByExampleStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_SELECT_FIRST_BY_EXAMPLE_STATEMENT_ID, s);
    }
